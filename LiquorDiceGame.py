...
from env import Env
from game import LiquorDiceGame as Game
...
class LiquorDiceGameEnv(Env):
    ...
    def __init__(self, config):
        """ Initialize the LiquorDiceGameEnv environment
        """
        self.name = 'liquor_dice_game'
    ...
    def _extract_state(self, state):
        ...
        extracted_state = {'obs': obs, 'legal_actions': legal_actions, 'raw_obs': state,
                           'raw_legal_actions': [a for a in self.actions], 'action_record': self.action_recorder}
